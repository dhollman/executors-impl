...
void oneway_executor_compile_test()
{
  ...
  ex6.submit(execution::receiver{});
  ex6.make_value_task(execution::sender{}, []{std::printf("hello world\n");})
  ...
  cex1.make_value_task(execution::sender{}, []{}).submit(execution::receiver{});
