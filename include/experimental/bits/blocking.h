...
#include <experimental/bits/behavioral.h>
...
struct never_blocking_t : behavioral_properties_impl::nested_behavioral_property_base<
  never_blocking_t, blocking_t
> {
  static constexpr bool is_preferable = true;
};

struct always_blocking_t : behavioral_properties_impl::nested_behavioral_property_base<
  always_blocking_t, blocking_t
> {
  static constexpr bool is_preferable = true;
};

struct possibly_blocking_t : behavioral_properties_impl::first_nested_behavioral_property_base<
  possibly_blocking_t, blocking_t,
  never_blocking_t,
  always_blocking_t
> {
  static constexpr bool is_preferable = true;
...
struct blocking_t
  : behavioral_properties_impl::behavioral_property_base<
      blocking_t,
      blocking_impl::possibly_blocking_t,
      blocking_impl::never_blocking_t,
      blocking_impl::always_blocking_t
    >
{
  private:

    using base_t = behavioral_properties_impl::behavioral_property_base<
      blocking_t,
      blocking_impl::possibly_blocking_t,
      blocking_impl::never_blocking_t,
      blocking_impl::always_blocking_t
  ...
  public:
    ...
    using possibly_t = blocking_impl::possibly_blocking_t;
    static constexpr auto possibly = possibly_t{};

    using always_t = blocking_impl::always_blocking_t;
    static constexpr auto always = always_t{};

    using never_t = blocking_impl::never_blocking_t;
    static constexpr auto never = never_t{};
    ...
    //      require(Executor ex, const always_t&)
...
class always_blocking_adapter
{
  ...
  public:
    ...
    always_blocking_adapter require(const blocking_t::always_t&) const & { return *this; }
    always_blocking_adapter require(const blocking_t::always_t&) && { return std::move(*this); }
    always_blocking_adapter require(const blocking_t::possibly_t&) const & { return *this; }
    always_blocking_adapter require(const blocking_t::possibly_t&) && { return std::move(*this); }
    ...
    constexpr auto query(const blocking_t::always_t&) const { return blocking_t{ blocking_t::always }; }
...
using possibly_blocking_t = blocking_t::possibly_t;
constexpr auto possibly_blocking = blocking_t::possibly;
using always_blocking_t = blocking_t::always_t;
constexpr auto always_blocking = blocking_t::always;
using never_blocking_t = blocking_t::never_t;
constexpr auto never_blocking = blocking_t::never;
